...
st.header("""
          Programa Colaborativo para la Protección del 
...
st.image("resources/images/colombia-heritage-logo.jpg", caption="Programa Colaborativo para la Protección del Patrimonio Industrial y Agroindustrial Colombiano")
